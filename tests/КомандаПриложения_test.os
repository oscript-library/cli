...
Процедура ТестДолжен_ПроверитьТекстОшибок() Экспорт
	...
	ТестовыеСлучаи = Новый Массив();
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("ARG -x", "ARG", "Неожидаемая опция -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("ARG -y -x", "ARG", "Неожидаемая опция -y"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-x ARG", "ARG", "Ожидается аргумент ARG вместо опции -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("", "ARG", "Ожидается аргумент ARG"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("ARG SRC", "ARG", "Неожидаемый параметр SRC"));
	
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-x", "-f", "Неожидаемая опция -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f val -x", "-f", "Неожидаемая опция -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-xb", "-f", "Неожидаемая опция -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-bx", "-f", "Ожидается опция -f вместо -b"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-b", "-f -s", "Неожидаемая опция -b"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f val -b", "-f -s", "Неожидаемая опция -b"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-s", "-f", "Ожидается опция -f вместо -s"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f val -s", "-f -b", "Ожидается опция -b вместо -s"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f val -s val", "-f -b", "Ожидается опция -b вместо -s"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f val", "-f -s", "Ожидается опция -s"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f", "-f", "Опция -f должна содержать значение"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-b=", "-b", "Опция -b должна содержать значение после знака ="));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-x=false", "-b", "Неожидаемая опция -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("ARG", "-f", "Неожидаемый параметр ARG"));		
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("", "[-f | -b] -s", "Ожидается опция -s"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("", "(-f | -b) -s", "Ожидается опция -f; Ожидается опция -b"));

	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--long", "--force", "Неожидаемая опция --long"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--force val --long", "--force", "Неожидаемая опция --long"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--bool", "--force", "Ожидается опция -f вместо --bool"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--string", "--force", "Ожидается опция -f вместо --string"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--force val --bool", "--force  --string", "Ожидается опция -s вместо --bool"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--force val --string", "--force --bool", "Ожидается опция -b вместо --string"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--force val --string val", "--force --bool", "Ожидается опция -b вместо --string"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--force val", "--force --string", "Ожидается опция -s"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("--force", "--force", "Опция --force должна содержать значение"));

	ТестовыеСлучаи.Добавить(ТестовыйСлучай("ARG -x", "ARG -f", "Неожидаемая опция -x"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("ARG", "ARG -f", "Ожидается опция -f"));	
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("", "[ARG] -f", "Ожидается опция -f"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-f val", "-f ARG", "Ожидается аргумент ARG"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("", "[-f] ARG", "Ожидается аргумент ARG"));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("", "[ARG] ((-f [-b | ARG]) | -b) -s", "Ожидается опция -f; Ожидается опция -b"));
	...
	Для Каждого ТестовыйСлучай Из ТестовыеСлучаи Цикл
		...
		Ожидаем.Что(Команда)
			.Метод("Запуск", ПараметрыМетода)
			.ВыбрасываетИсключение(ТестовыйСлучай.Результат);
