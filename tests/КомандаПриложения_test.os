...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_ПроверитьОпцииПослеПозиционногоАргумента");
...
Процедура ТестДолжен_ПроверитьОпцииПослеПозиционногоАргумента() Экспорт

	Команда = ПодготовитьТестовуюКоманду();

	ОпцияОтчет = Команда.Опция("r report", "", "Тестовая опция со значением");
	ОпцияФлаг = Команда.Опция("f force", Ложь, "Тестовый флаг").Флаг();
	ARG1 = Команда.Аргумент("ARG1", "", "Тестовый аргумент").Обязательный(Ложь);

	Аргументы = Новый Массив;

	Аргументы.Добавить("ЗначениеАргумента");
	Аргументы.Добавить("--report");
	Аргументы.Добавить("build/junit.xml");
	Аргументы.Добавить("-f");

	РезультатВыполнения = ВыполнитьКомандуПриложения(Команда, Аргументы);

	Утверждения.ПроверитьИстину(РезультатВыполнения, "Команда с опциями после позиционного аргумента должна выполниться");
	Утверждения.ПроверитьРавенство(ОпцияОтчет.Значение, "build/junit.xml", "Значение опции после аргумента должно быть прочитано");
	Утверждения.ПроверитьРавенство(ОпцияФлаг.Значение, Истина, "Флаг после аргумента должен быть прочитан");
	Утверждения.ПроверитьРавенство(ARG1.Значение, "ЗначениеАргумента", "Значение аргумента должно быть прочитано");
