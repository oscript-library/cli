...
Процедура ТестДолжен_ПроверитьТекстОшибок() Экспорт
	...
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-b=", "-b", ОшибкиПарсера.ОшибкаТребуетсяЗначениеДляОпции("b")));
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-b=", "[-b]", ОшибкиПарсера.ОшибкаТребуетсяЗначениеДляОпции("b")));
	...
	ТестовыеСлучаи.Добавить(ТестовыйСлучай("-b=", "[ОПЦИИ]", ОшибкиПарсера.ОшибкаТребуетсяЗначениеДляОпции("b")));
