...
Процедура ТестДолжен_ПроверитьПриложения() Экспорт
	...
	оп_v = КомандаAve.Опция("v vers", Ложь, "Тест").Флаговый();
	оп_s = КомандаAve.Опция("s ssss", Ложь, "Тест").Флаговый();;
	оп_b = КомандаAve.Опция("b bbbb", Ложь, "Тест").Флаговый();;
	ARG = КомандаAve.Аргумент("ARG", "", "Тест");
	SRC = КомандаAve.Аргумент("SRC", "", "Тест");
