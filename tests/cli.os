...
Процедура ТестДолжен_ПроверитьПриложения() Экспорт
	...
	оп_v = КомандаAve.Опция("v vers", Ложь, "Тест").Флаговый().ВПеременную(оп_v);
	on_s = КомандаAve.Опция("s ssss", Ложь, "Тест").Флаговый().ВПеременную(on_s);
	on_b = КомандаAve.Опция("b bbbb", Ложь, "Тест").Флаговый().ВПеременную(on_b);
	...
	Сообщить("-v "+ оп_v.Значение);
	Сообщить("-b "+ on_b.Значение);
	Сообщить("-s "+ on_s.Значение);
	Сообщить("ARG "+ ARG.Значение);
	Сообщить("SRC "+ SRC.Значение);
