...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_ПроверитьОшибкуПарсингАргументов");
	ИменаТестов.Добавить("ТестДолжен_ПроверитьПарсингОпцийПослеАргументов");
...
Процедура ТестДолжен_ПроверитьПарсингАргументов() Экспорт
	...
	INT = Аргумент("SRC", "").ТЧисло();
	DATE = Аргумент("SRC", "").ТДата();
	...
	// ARG_Парсера = Новый АргументыПарсера(ARG, ИндексАргументов);
	// Утверждения.ПроверитьРавенство("ARG", О_Парсера.ВСтроку(), "Парсер опции должен быть равен -f");
...
Процедура ТестДолжен_ПроверитьОшибкуПарсингАргументов() Экспорт
...
Процедура ТестДолжен_ПроверитьПарсингОпцийПослеАргументов() Экспорт
