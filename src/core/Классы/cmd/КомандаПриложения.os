...
Процедура Запуск(Знач АргументыCLI) Экспорт
	...
	Лог.Отладка("Количество входящих аргументов команды <%2>: %1", АргументыCLI.Количество(), ПолучитьИмяКоманды());
	Лог.Отладка("Последний индекс аргументов команды <%2>: %1", ПоследнийИндекс, ПолучитьИмяКоманды());
...
#Область Работа с входящими аргументами
...
#Область Работа с индексом опций и аргументов
...
#Область Работа с рефлектором объектов
