...
// Возвращает список опций команды в виде массива объектов ПараметрКоманды,
// для расширенной работы с параметрами (например, автодополнение).
//
// Возвращаемое значение:
//   Массив из ПараметрКоманды
//
Функция ПолучитьОпцииПараметрами() Экспорт
...
// Возвращает список аргументов команды в виде массива объектов ПараметрКоманды,
// для расширенной работы с параметрами (например, автодополнение).
//
// Возвращаемое значение:
//   Массив из ПараметрКоманды
//
Функция ПолучитьАргументыПараметрами() Экспорт
