...
Функция ПолучитьТаблицуПараметров(ИндексПараметров)
	...
	Для каждого КлючЗначение Из Опции Цикл
		...
		НоваяЗапись.Наименование = ОпцияСправки.Имя;
		НоваяЗапись.Описание = ОпцияСправки.Описание;
		НоваяЗапись.ПодробноеОписание = ОпцияСправки.ПолучитьПодробноеОписание();
		НоваяЗапись.ПеременнаяОкружения = ОпцияСправки.ПеременнаяОкружения;
		НоваяЗапись.СкрытьЗначение = ОпцияСправки.СкрытьЗначение;
		НоваяЗапись.НаименованияПараметров = ОпцияСправки.НаименованияПараметров;
		НоваяЗапись.Значение = ОпцияСправки.ЗначениеВСтроку();
