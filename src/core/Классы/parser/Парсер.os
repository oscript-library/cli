...
Функция Прочитать() Экспорт
	...
	НачальноеСостояние.СообщитьСоединения();
	...
	Лог.Отладка("Выход Прочитать() >> СледующиеСостояние.Завершено: %1", НачальноеСостояние.МассивСоединений[0].СледующееСостояние.Завершено);
	НачальноеСостояние.СообщитьСоединения();
