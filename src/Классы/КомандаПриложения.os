...
Процедура ВывестиСправку() Экспорт
	...
	КонсольВывода.Вывести(СтрШаблон("%4 Использование: %1 %2 %3",ПутьИспользования, Спек, СуффиксВложенныхКоманды, Символы.Таб));
	КонсольВывода.ЦветТекста = ЦветВключенныйПлагин;
