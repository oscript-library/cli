...
Для PR в cmdline, слишком большые изменения в API, т.е. обеспечить совместимость очень трудоемко.
Сравнительная таблица возможностей:

|                                                                                   | 1cli | cmdline |
|-----------------------------------------------------------------------------------|------|---------|
| Встроенная команда help                                                           | ✓    | ✓       |
| Автоматическая генерации справки по приложению и командам                         | ✓    | ✓       |
