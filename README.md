...
Для установки основной функции выполнения приложения необходимо создать класс или модуль должен реализовывать экспортную процедуру:
```bsl
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
КонецПроцедуры
```
