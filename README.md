...
| Проверка аргументов : `SRC DST`                                              | ✓       |                 |
| Необязательные аргументы : `SRC [DST]`                                       | ✓       |                 |
| Повторение аругментов : `SRC... DST`                                         | ✓       |                 |
| Зависимость опций и аргументов друг от друга : `SRC [-f DST]`                | ✓       |                 |
| Формирование своей строки выполнения: `[-d ❘ --rm] IMAGE [COMMAND [ARG...]]` | ✓       |                 |
...
повторение опции создаст массив данных опций:
...
1cli позвляет произвольно настроивать порядок использования опций и аргументов:
